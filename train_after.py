...
from model.pointnet import ClassificationPointNet, SegmentationPointNet,SegmentationPointNet_contrast_with_head,SegmentationPointNet_contrast
...
if __name__ == '__main__':
    ...
    MODELS = {
                ...
                'segmentation': SegmentationPointNet_contrast_with_head
            }
    ...
    model_back_bone = SegmentationPointNet_contrast(num_classes=train_dataset.NUM_SEGMENTATION_CLASSES,
