...
from model.pointnet import ClassificationPointNet, SegmentationPointNet_contrast
...
if __name__ == '__main__':
    ...
    MODELS = {
                ...
                'segmentation': SegmentationPointNet_contrast
            }
    ...
    if args.task == 'segmentation':
            model = SegmentationPointNet_contrast(num_classes=train_dataset.NUM_SEGMENTATION_CLASSES,
