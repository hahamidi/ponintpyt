...
from model.pointnet import ClassificationPointNet, SegmentationPointNet_Dual
...
class Trainer():
    ...
    def train_one_epoch(self,epoch_num):
                ...
                for idx,data in batch_iter:
                    ...
                    preds,feature_128,feature_transform = self.model(points)
                    loss2 = contrast_loss(feature_128,targets)
                    # if idx == 0:
...
if __name__ == '__main__':
    ...
    if args.task == 'classification':
            ...
            model = SegmentationPointNet_Dual(num_classes=train_dataset.NUM_SEGMENTATION_CLASSES,
                                     point_dimension=train_dataset.POINT_DIMENSION)
    else:
